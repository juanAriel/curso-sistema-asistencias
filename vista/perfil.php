...
<div class="page-content">
    ...
    <h4 class="text-center text-secondary">datos del usuario logeado</h4>
    <?php 
    ...
    <div class="row">
        ...
        <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
            ...
            <div class="text-right p-2">
                ...
                <button type="submit" value="ok" name="btnmodificar" class="btn btn-primay btn-rounded">Modificar</button>
            </div>
            <?php }
            ?>
